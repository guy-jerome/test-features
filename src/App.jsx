...
export default function App() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', width: '50vw', height: '100vh' }}>
      <Editor
        height="50%"
        width="100%"
      ...
      />
      <button onClick={executeCode} style={{ width: '20%', alignSelf: 'flex-end' }}>
        Execute Code
      </button>
      <textarea
        value={output}
        style={{ border: '2px solid black', width: '100%', height: '50%', resize: 'none' }}
        readOnly
      />
    </div>
  );
